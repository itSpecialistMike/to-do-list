        ...
        <footer className="bg-white">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-2 lg:py-2">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <div>
                        <h2 className="mb-0 text-sm font-semibold text-gray-900 uppercase dark:text-white">Follow us</h2>
                    ...
                    <div>
                        <h2 className="mb-0 text-sm font-semibold text-gray-900 uppercase dark:text-white">Legal</h2>
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            <li>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-center">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
                        © 2027 <a href="https://flowbite.com/" className="hover:underline">Егор и Мишаня™</a>. All Rights Reserved.
                    </span>
